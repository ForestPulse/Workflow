...
/*
  get the datacube as it exists
  attach the DWD file (where is it? there should be a folder and locations)
  merge in the new faux cell (or a soft link to it)
  (does it require to be on the new location all together?)
  then do the processing
  then merge it all as a cube (do not publishdir, but make an structure, like a reduce?)
*/

// TODO: a function that returns a splined cube goes here.

workflow thermal_time_spline {
