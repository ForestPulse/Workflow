...
process fill_parameter_stats {
  ...
  maskfile="${params.disturbances.mask_file}"
  ...
  sed -i "/^DATE_RANGE /c\\DATE_RANGE = ${params.disturbances.reference_start}-01-01 ${params.disturbances.reference_end}-12-31" "filled_${parfile}"
